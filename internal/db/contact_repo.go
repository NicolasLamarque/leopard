...
func (db *Database) CreateContact(req models.CreateContactRequest, cryptoSvc *crypto.CryptoService) (int64, error) {
	...
	query := `
        INSERT INTO contacts (
            ...
            force_lien, force_niv_maltraitance, force_niv_soutien, force_niv_epuisement, contact_urgence, aidant_naturel, type_de_contact,
	...
	resultat, err := db.NamedExec(query, map[string]interface{}{
		...
		"force_niv_maltraitance": encryptedReq.ForceMaltraitance,
		"force_niv_soutien":      encryptedReq.ForceSoutien,
		"force_niv_epuisement":   encryptedReq.ForceEpuisement,
...
func (db *Database) UpdateContact(req models.UpdateContactRequest, cryptoSvc *crypto.CryptoService) error {
	...
	query := `
		UPDATE contacts SET
			...
			force_niv_maltraitance = :force_niv_maltraitance,
			force_niv_soutien = :force_niv_soutien,
			force_niv_epuisement = :force_niv_epuisement,
