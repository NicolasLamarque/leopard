...
type Client struct {
	...
	PremiereNationID         *int    `db:"premiere_nation_id" json:"premiere_nation_id,omitempty"`
	PremiereNationCommunaute *string `db:"premiere_nation_communaute" json:"premiere_nation_communaute,omitempty"`
